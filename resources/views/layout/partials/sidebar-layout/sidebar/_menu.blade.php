	...
	<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
		...
		<div class="menu menu-column menu-rounded menu-sub-indention px-3 fw-semibold fs-6" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
			...
			<div class="menu-item">
				...
				<!--begin:Menu link-->
				<a class="menu-link" href="{{ route('email.templates') }}">
			...
			<!-- begin:product menu -->
			<div class="menu-item">
				@canany(['create product','write product','delete product','read product'])
				<!--begin:Menu link-->
				<a class="menu-link" href="{{ route('product') }}">
					<span class="menu-icon">{!! getIcon('abstract-28', 'fs-2') !!}</span>
					<span class="menu-title">Product Manegement</span>
				</a>
				<!--end:Menu link-->
				@endcanany
			</div>
			...
			<div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ request()->routeIs('user-management.*') ? 'here show' : '' }}">
				@canany(['create user management','write user management','delete user management','read user management'])
				<!--begin:Menu link-->
				<span class="menu-link">
					<span class="menu-icon">{!! getIcon('abstract-28', 'fs-2') !!}</span>
