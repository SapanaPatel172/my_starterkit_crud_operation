    ...
    <div class="card">
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-body py-4">
                <!--begin::Form-->
                <form id="create_email_template_form" class="form" method="POST"  action="{{ route('email-templates.update', ['id' => $emailTemplates->id]) }}">
                    @csrf
                    <div class="d-flex">
                        <div class="col-6">
                            <!--begin::Input group-->
                        ...
                        <div class="col-6 ms-2">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <select name="status" class="form-select form-select-solid mb-3 mb-lg-0">
                                    ...
                                    <option value="{{ $status }}" @if($emailTemplates->status === $status) selected @endif>{{ $status }}</option>
                                    @endforeach
                                </select>
                                <!--end::Input-->
                                @error('status')
